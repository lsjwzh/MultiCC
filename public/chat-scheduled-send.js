(function attachMultiCCChatScheduledSend(global) {
  ...
  function addStyles(documentRef) {
    ...
    style.textContent = [
      ...
      '#schedule-send-btn .schedule-badge{position:absolute;right:-4px;top:-5px;min-width:16px;height:16px;padding:0 4px;border-radius:9px;background:var(--chat-warning, #d29922);color:var(--chat-canvas, #0d1117);font:700 10px/16px system-ui;text-align:center}',
      ...
      '.schedule-fab-circle{position:relative;width:24px;height:24px;border:1px solid var(--chat-warning, #e3b341);border-radius:50%;background:#9e6a03;display:flex;align-items:center;justify-content:center;box-shadow:0 6px 20px #000a;font-size:12px;line-height:1;pointer-events:none}',
      '#schedule-send-fab:hover .schedule-fab-circle{background:#bb8009}#schedule-send-fab.schedule-send-dragging{cursor:grabbing}#schedule-send-fab:focus-visible{outline:2px solid var(--chat-warning, #e3b341);outline-offset:2px}',
      '#schedule-send-fab-count{position:absolute;right:-5px;top:-5px;min-width:15px;height:15px;box-sizing:border-box;padding:0 3px;border:1px solid var(--chat-canvas, #0d1117);border-radius:8px;background:#d73a49;color:#fff;font:700 9px/13px monospace;text-align:center}',
      '#schedule-send-panel{position:fixed;z-index:12000;width:min(440px,calc(100vw - 24px));max-height:min(62vh,520px);display:flex;flex-direction:column;background:var(--chat-surface, rgba(22,27,34,.96));backdrop-filter:blur(12px);border:1px solid #6e5502;border-radius:12px;box-shadow:0 16px 48px #000a;color:var(--chat-text, #c9d1d9);overflow:hidden}',
      '.schedule-head{display:flex;align-items:center;gap:8px;padding:11px 12px;border-bottom:1px solid var(--chat-line, #30363d)}',
      '.schedule-head-icon{color:var(--chat-warning, #e3b341)}.schedule-title{flex:1;font-size:14px;font-weight:700;color:var(--chat-heading, #f0f6fc)}',
      '.schedule-close,.schedule-cancel{border:1px solid var(--chat-line, #30363d);background:var(--chat-soft, #21262d);color:var(--chat-text, #c9d1d9);border-radius:7px;cursor:pointer}',
      '.schedule-close{width:30px;height:30px;font-size:18px;line-height:1}',
      '.schedule-body{padding:12px;overflow:auto}',
      '.schedule-hint{margin-bottom:10px;color:var(--chat-muted, #8b949e);font-size:11px;line-height:1.45}',
      '.schedule-controls{display:grid;grid-template-columns:minmax(0,1fr) minmax(90px,auto) auto;gap:7px;align-items:end}',
      '.schedule-field{display:flex;flex-direction:column;gap:4px;color:var(--chat-muted, #8b949e);font-size:11px}',
      '.schedule-field input,.schedule-field select{height:36px;box-sizing:border-box;border:1px solid var(--chat-line, #30363d);border-radius:7px;background:var(--chat-canvas, #0d1117);color:var(--chat-text, #c9d1d9);padding:0 9px;font-size:14px}',
      ...
      '.schedule-status{min-height:18px;margin:8px 0 2px;font-size:11px;color:var(--chat-muted, #8b949e)}.schedule-status.ok{color:var(--chat-success, #3fb950)}.schedule-status.error{color:var(--chat-danger, #f85149)}',
      '.schedule-list-head{display:flex;justify-content:space-between;gap:8px;margin:10px 0 6px;padding-top:9px;border-top:1px solid var(--chat-soft, #21262d);font-size:12px;font-weight:650}',
      '.schedule-count{color:var(--chat-muted, #8b949e);font-size:11px;font-weight:400}',
      '.schedule-empty{padding:14px 6px;text-align:center;color:var(--chat-muted, #6e7681);font-size:12px}',
      '.schedule-item{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;padding:9px 0;border-top:1px solid var(--chat-soft, #21262d)}',
      '.schedule-item:first-child{border-top:0}.schedule-message{display:-webkit-box;overflow:hidden;-webkit-box-orient:vertical;-webkit-line-clamp:2;white-space:normal;word-break:break-word;font-size:12px;line-height:1.4;color:var(--chat-text, #c9d1d9)}',
      '.schedule-time{margin-top:4px;color:var(--chat-muted, #6e7681);font-size:10px}.schedule-remaining{color:var(--chat-warning, #d29922);margin-left:6px}',
      '.schedule-cancel{align-self:center;padding:5px 9px;font-size:11px}.schedule-cancel:hover{border-color:var(--chat-danger, #f85149);color:var(--chat-danger, #ff7b72)}.schedule-cancel:disabled{opacity:.55}',
