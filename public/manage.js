...
/* Bridge UI is owned by public/manage-bridges.js. */

/* Push, host access, proxy and tunnel UI live in public/manage-host-settings.js. */
...
loadAsrSettings();
loadCronTasks();
window.MultiCCManageHostSettings.initialize();
loadAgentSkills();
loadSkillSyncStatus();
loadClaudeHistory();
loadUploadStats();
