(function () {
  ...
  const I18N = {
    zh: {
      ...
      autoCommitOn: '🚀 自动提交✓',
      autoCommitOff: '🚀 自动提交✕',
      autoCommitTitle: '任务完成后自动 commit 并合并回基分支',
      autoCommitPerMsg: '完成后自动提交合并',
      share: '🔗 分享',
      language: '中/EN',
    },
    en: {
      ...
      autoCommitTitle: 'Auto commit & merge back to base branch after task completion',
      autoCommitPerMsg: 'Auto commit & merge when done',
      share: '🔗 Share',
      language: 'EN/中',
    },
  };
